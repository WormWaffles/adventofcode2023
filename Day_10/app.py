...
def all_neighs(z):
    ...
    return([z + (1 + 0j), z + (-1 + 0j), z + (1 + 1j), z + (-1 + 1j), z + (1 - 1j), z + (-1 - 1j), z + (0 + 1j), z + (0 - 1j)])
...
data =[['.']+[y for y in x]+['.'] for x in open('Day_10/fileinput.txt').read().split('\n')]
...
direcs = {'F': [0 + 1j, 1 + 0j], '7' : [-1 + 0j, 0 + 1j ] , 'J' : [0 - 1j, -1 + 0j], 'L': [1 + 0j, 0 - 1j], '-' : [1 + 0j, -1 + 0j], '|' : [0 + 1j, 0 - 1j], '.' : [] }
